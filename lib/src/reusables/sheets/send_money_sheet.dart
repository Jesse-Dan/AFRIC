...
class SendFundsSheet extends StatefulWidget {
  const SendFundsSheet({super.key});

  @override
  State<SendFundsSheet> createState() => _SendFundsSheetState();
}

class _SendFundsSheetState extends State<SendFundsSheet> {
